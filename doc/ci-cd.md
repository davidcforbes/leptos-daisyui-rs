...
| `test-ai-assistant-contract` | `cargo test -p leptos-daisyui-rs --test ai_assistant_contract` | Source/contract guard for the AI assistant workspace surface (capabilities, wire, governance). |
...
`cargo xtask verify` is the 20-step native gate listed in the table above.
